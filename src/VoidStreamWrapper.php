...
class VoidStreamWrapper extends AbstractStreamWrapper
{
     ...
     *                        (The method was called in response to chown() with string parameter)
     ...
     *                             opened_path should be set to the full path of
     *                             the file/resource that was actually opened.
     *
     * @return bool
     *
